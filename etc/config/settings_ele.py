...
samplesDef = {
    ...
    'mcNom'  : tnpSamples.CMSDAS19_94X['DY_madgraph'].clone(),
    'mcAlt'  : None,
    'tagSel' : None
...
if not samplesDef['mcNom' ] is None: samplesDef['mcNom' ].set_puTree('/gpfs/ddn/cms/user/cmsdas/2019/EgammaExercise/TnP/mc/DY_madgraph_ele.pu.puTree.root')
